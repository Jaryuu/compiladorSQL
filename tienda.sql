...
CREATE TABLE recibo (idCliente int, idProducto int, totalCompra float );
ALTER TABLE recibo ADD CONSTRAINT PRIMARY KEY pkRecibo(idCliente,idProducto); ALTER TABLE recibo ADD CONSTRAINT FOREIGN KEY fkReciboClie (idCliente) REFERENCES cliente(id);
